...
def EmployeeLogin():
    ...
    if not len(field[0] or field[1]) < 1:
        text_file = open("C:/Leave System/employee.csv")
...
def EmployeeAllInformationWindow():
    ...
    text_file = open("C:/Leave System/employee.csv", 'r')
...
def balance():
    ...
    my_text.pack(pady=20)
    text_file = open("C:/Leave System/balance.csv", 'r')
    stuff = text_file.read()
    my_text.insert(END, stuff)
    text_file.close()
...
def process_leave_choice(fieldValues, choice, leaveid, rowIndex):
    text_file = open("C:/Leave System/balance.csv")
    csvreader = csv.reader(text_file)
    data=[]
    for row in csvreader:
         data.append(row)
    ...
    filename = "C:/Leave System/balance.csv"
    with open(filename, 'w') as file:
       for row in data:
         ...
         file.write('\n')
    text_file.close()
    text_file2 = open("C:/Leave System/status.csv", 'a')
...
def leavelist():
    ...
    my_text.pack(pady=20)
    text_file = open("C:/Leave System/status.csv", 'r')
    stuff = text_file.read()
    my_text.insert(END, stuff)
    text_file.close()
...
def registration():
    ...
    text_file = open("C:/Leave System/employee.csv", 'a')
    text_file.write(fieldValues[0]+","+fieldValues[1]+","+fieldValues[2]+","+fieldValues[3] +"\n")
    text_file.close()

    text_file2 = open("C:/Leave System/balance.csv", 'a')
...
root.iconbitmap(default="C:/Leave System/leavelogo.ico")
filename = PhotoImage(file="C:/Leave System/background.gif")
...
im = PhotoImage(file="C:/Leave System/login.gif")
